...
public static class stb_vorbis
{
	...
	[CLink] public static extern c_int stb_vorbis_get_error(stb_vorbis* f);
	...
	[CLink] public static extern c_int stb_vorbis_get_sample_offset(stb_vorbis* f);

	// returns the current seek point within the file, or offset from the beginning
	// of the memory buffer. In pushdata mode it returns 0.
	[CLink] public static extern c_uint stb_vorbis_get_file_offset(stb_vorbis* f);
	...
	[CLink] public static extern c_int stb_vorbis_seek_frame(stb_vorbis* f, c_uint sample_number);
	[CLink] public static extern c_int stb_vorbis_seek(stb_vorbis* f, c_uint sample_number);


	// this function is equivalent to stb_vorbis_seek(f,0)
	[CLink] public static extern c_int stb_vorbis_seek_start(stb_vorbis* f);

	// these functions return the total length of the vorbis stream
	[CLink] public static extern c_uint stb_vorbis_stream_length_in_samples(stb_vorbis* f);
	...
	[CLink] public static extern c_int stb_vorbis_get_frame_short_interleaved(stb_vorbis* f, c_int num_c, c_short* buffer, c_int num_shorts);
	[CLink] public static extern c_int stb_vorbis_get_frame_short(stb_vorbis* f, c_int num_c, c_short** buffer, c_int num_samples);
#endif
	...
	[CLink] public static extern c_int stb_vorbis_get_samples_float_interleaved(stb_vorbis* f, c_int channels, float* buffer, c_int num_floats);
	[CLink] public static extern c_int stb_vorbis_get_samples_float(stb_vorbis* f, c_int channels, float** buffer, c_int num_samples);
	...
	[CLink] public static extern c_int stb_vorbis_get_samples_short_interleaved(stb_vorbis* f, c_int channels, c_short* buffer, c_int num_shorts);
	[CLink] public static extern c_int stb_vorbis_get_samples_short(stb_vorbis* f, c_int channels, c_short** buffer, c_int num_samples);
#endif
