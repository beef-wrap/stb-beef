...
USAGE:
   ...
   There are five functions, one for each image file format:
	 ...
	 int stbi_write_png(char8* filename, int w, int h, int comp, const void *data, int stride_in_bytes);
	 int stbi_write_bmp(char8* filename, int w, int h, int comp, const void *data);
	 int stbi_write_tga(char8* filename, int w, int h, int comp, const void *data);
	 int stbi_write_jpg(char8* filename, int w, int h, int comp, const void *data, int quality);
	 int stbi_write_hdr(char8* filename, int w, int h, int comp, const float *data);
